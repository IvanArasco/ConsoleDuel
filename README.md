* Se trata de una simulación de combate RPG por turnos de uno contra uno, por consola.
* El jugador empieza con 20 de vida.
* El enemigo que aparece tiene estadísticas aleatorias.
* Se tiene en cuenta el crítico en defensa y ataque tanto del jugador como del enemigo.
* Cuenta con varios escenarios:
  - Emboscada
  - Encuentro normal
  - Recuperación
...
- Destino final (fin del juego) --> Boss final.
